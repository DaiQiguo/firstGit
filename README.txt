...
Here are some very brief notes on using the PSIPRED V3 software.
...
tcsh% pfilt nr.fasta > nrfilt

tcsh% formatdb -t nrfilt -i nrfilt

tcsh% cp nrfilt.p?? $BLASTDB
